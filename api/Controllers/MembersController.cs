    ...
    IPhotoService photoService) : BaseApiController
{
    ...
    public async Task<ActionResult<Photo>> AddPhoto([FromForm] IFormFile file)
    {
        ...
        return BadRequest("Problemo adding photo");
    }
    ...
    public async Task<ActionResult> SetMainPhoto(int photoId)
    {
        ...
        if (member == null) return BadRequest("Can't get member from token");

        var photo = member.Photos.SingleOrDefault(x => x.Id == photoId);

        if (member.ImageUrl == photo?.Url || photo == null)
        {
            return BadRequest("Can't set this as the main image");
        }
    ...
    public async Task<ActionResult> DeletePhoto(int photoId)
    {
        ...
        {
            return BadRequest("This photo can't be deleted, buddy");
        }
